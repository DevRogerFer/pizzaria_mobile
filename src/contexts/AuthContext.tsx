import React, {useState, createContext, ReactNode, useEffect, use} from "react";
...
export function AuthProvider({children}: AuthProviderProps) {
    ...
    useEffect(() => {
        async function getUser() {
            // pegar os dados do usuário no async storage
    ...
    async function signIn({email, password}: SignInProps) {
        ...
        try {
            ...
            const { id, name, token } = response.data.auth;
